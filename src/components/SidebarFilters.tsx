...
import { ShieldCheck, Building2, User, RotateCcw, Filter } from 'lucide-react';
...
export const SidebarFilters: React.FC<SidebarFiltersProps> = ({
  ...
  return (
    <aside className="w-full lg:w-60 flex-shrink-0 bg-white p-4 rounded shadow-sm border border-zinc-200 text-zinc-800 space-y-6">
      ...
      <div className="space-y-2 pb-4 border-b border-zinc-200">
        <h3 className="font-bold text-sm mb-3 text-zinc-500 uppercase tracking-tight">
          Condición
        </h3>
      ...
      <div className="space-y-2 pb-4 border-b border-zinc-200">
        ...
        <div className="max-h-48 overflow-y-auto space-y-1 text-sm text-zinc-600 pr-1 no-scrollbar">
          {BRANDS.map((brand) => {
      ...
      <div className="space-y-2 pb-4 border-b border-zinc-100 dark:border-zinc-800">
        ...
        <div className="flex items-center gap-2 text-xs">
          <input
            ...
            className="w-full p-2 border border-zinc-300 dark:border-zinc-700 rounded bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        ...
        <div className="flex flex-wrap gap-1 mt-2">
          <button
            ...
            className="text-[10px] px-2 py-1 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded text-zinc-700 dark:text-zinc-300 font-medium"
          >
            Hasta $400k
          </button>
          <button
        ...
        <div className="space-y-1 text-sm text-zinc-600 dark:text-zinc-400">
          {LOCATIONS_MEXICO.map((loc) => {
            ...
            return (
              <label
                key={loc}
                className="flex items-center justify-between py-1 px-1 rounded hover:bg-zinc-50 dark:hover:bg-zinc-800 cursor-pointer text-zinc-700 dark:text-zinc-300"
              >
                <span>{loc}</span>
                <input
                  type="checkbox"
